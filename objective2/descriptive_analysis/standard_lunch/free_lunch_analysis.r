...
calculate_statistics <- function(score_column) {
  ...
  size_muestra <- format(nrow(muestra_standard_lunch), nsmall = 0)
...
standard_lunch_table <- make_table(column_names, standard_lunch_stats) %>% change_table_names()

make_table_plot(standard_lunch_table,"objective2/descriptive_analysis/standard_lunch/images/standard_lunch_table_plot.png")

make_histogram_plot(
  data = muestra_standard_lunch,
  column = "promedio",
  binwidth = 5,
  fill_color = "blue",
  border_color = "black",
