...
calculate_statistics <- function(score_column) {
  ...
  size_muestra <- format(nrow(muestra_grupo_e), nsmall = 0)
...
muestra_grupo_e <- data %>%
  select(race_ethnicity, math_score, reading_score, writing_score) %>%
  filter(race_ethnicity == "group E")


math_stats <- calculate_statistics(muestra_grupo_e$math_score)
reading_stats <- calculate_statistics(muestra_grupo_e$reading_score)
writing_stats <- calculate_statistics(muestra_grupo_e$writing_score)
...
make_table_plot(math_table,"objective3/descriptive_analysis/group_e/images/math_table_plot.png")
make_table_plot(writing_table,"objective3/descriptive_analysis/group_e/images/writing_table_plot.png")
make_table_plot(reading_table,"objective3/descriptive_analysis/group_e/images/reading_table_plot.png")



make_histogram_plot(
  data = muestra_grupo_e,
  ...
  title = "",
  x_label = "Math Score",
  file_path = "objective3/descriptive_analysis/group_e/images/math_hist_plot.png"
)
...
make_histogram_plot(
  ...
  file_path = "objective3/descriptive_analysis/group_e/images/writing_hist_plot.png"
)
...
make_histogram_plot(
  ...
  file_path = "objective3/descriptive_analysis/group_e/images/reading_hist_plot.png"
)
...
make_box_plot(
  ...
  title = "",
  y_label = "Math Score",
  file_path = "objective3/descriptive_analysis/group_e/images/math_box_plot.png",
  outlier_color = "red",
  width = 4,
  height = 6  
)
make_box_plot(
  ...
  file_path = "objective3/descriptive_analysis/group_e/images/writing_box_plot.png",
  outlier_color = "red",
  width = 4,
  height = 6  
)
make_box_plot(
  ...
  file_path = "objective3/descriptive_analysis/group_e/images/reading_box_plot.png",
  outlier_color = "red",
  width = 4,
  height = 6  
)
